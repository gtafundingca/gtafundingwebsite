      ...
      >
        <ScrollReveal className="mx-auto max-w-6xl">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:items-stretch">
            ...
            <ServiceCard
              theme="light"
              imageSrc="/Women%20Entrepreneur.jpg"
            ...
            <ServiceCard
              ...
              imageSrc="/money.jpg"
              coverPositionClassName="object-[50%_55%]"
              imageAlt="Hands stacking coins — government grant and financial advisory"
            ...
            <ServiceCard
              ...
              coverPositionClassName="object-[28%_center]"
              imageAlt="Entrepreneur looking at city skyline — launch your vision with flexible capital"
